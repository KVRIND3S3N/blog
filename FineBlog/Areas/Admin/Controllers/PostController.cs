...
namespace FineBlog.Areas.Admin.Controllers
{
    ...
    public class PostController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreatePostVM vm)
        {
            ...
            _notification.Success("Post başarıyla oluşturuldu");
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if (loggedInUserRole[0] == WebsiteRoles.WebsiteAdmin || loggedInUser?.Id == post?.ApplicationUserId)
            {
                ...
                await _context.SaveChangesAsync();
                _notification.Success("Post başarıyla silindi");
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            if(post == null)
            {
                _notification.Error("Post bulunmamadı");
                return View();
            }
        ...
        public async Task<IActionResult> Edit(CreatePostVM vm)
        {
            ...
            if (post == null)
            {
                _notification.Error("Post bulunamadı");
                return View();
            }
            ...
            await _context.SaveChangesAsync();
            _notification.Success("Post güncelleme başarılı");
            return RedirectToAction("Index", "Post", new { area = "Admin" });
        }
